...
Value createApproxCos(OpBuilder &b, Location loc, Value x, MathMode mode) {
  ...
  SinCosResult approxSinCosBoundedFast(OpBuilder &b, Location loc, Value x) {
    ...
    Value sinC7 = arith::ConstantOp::create(
        b, loc, f32, b.getF32FloatAttr(-0.000195168955f));
    Value sinC5 = arith::ConstantOp::create(b, loc, f32,
                                            b.getF32FloatAttr(0.00833220803f));
    Value sinC3 = arith::ConstantOp::create(
        b, loc, f32, b.getF32FloatAttr(-0.166666567325f));
    ...
    Value cosC6 = arith::ConstantOp::create(
        b, loc, f32, b.getF32FloatAttr(-0.001388837214f));
    Value cosC4 = arith::ConstantOp::create(b, loc, f32,
                                            b.getF32FloatAttr(0.041666526347f));
    Value cosC2 = arith::ConstantOp::create(
        b, loc, f32, b.getF32FloatAttr(-0.499999850988f));
